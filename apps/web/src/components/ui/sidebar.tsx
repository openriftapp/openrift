      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{m.ui_sidebar_title() /* custom: localized */}</SheetTitle>
            <SheetDescription>
              {m.ui_sidebar_description() /* custom: localized */}
            </SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">{m.ui_sidebar_toggle() /* custom: localized */}</span>
    </Button>
  );
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={m.ui_sidebar_toggle() /* custom: localized */}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={m.ui_sidebar_toggle() /* custom: localized */}
      className={cn(
