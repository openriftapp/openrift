  ...
  return (
    <div className="flex h-10 items-end gap-6 border-b">
      <Tabs
        ...
        className="-mb-px"
      >
        <TabsList variant="line" aria-label="Deck views">
          <TabsTrigger value="overview">Deck</TabsTrigger>
          <TabsTrigger value="test">Test</TabsTrigger>
          {showPlanTab && <TabsTrigger value="plan">Plan</TabsTrigger>}
          {showBoxTab && <TabsTrigger value="box">Box</TabsTrigger>}
        </TabsList>
      </Tabs>
      {inlineTrailing && (
